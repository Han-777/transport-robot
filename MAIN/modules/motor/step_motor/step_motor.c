...
// void StepMotorMove(StepMotorInstance *instance, uint16_t target_pulse, GPIO_PinState motor_direction)
// {

//     setTargetPulse(instance, target_pulse, motor_direction);
//     instance->stop_flag = MOTOR_RUN;
//     instance->motor_finish_flag = motor_running;
// }
// /**
//  * @brief step motor control function
//  *        if motor finish flag is not finish, the next step should not be implemented
